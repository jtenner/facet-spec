...
(module
  ...
  (import "facet" "fd_write_array_i64" (func $writea (param i32 (ref array) i64 i64) (result i64 i32)))
  ...
  (memory 1)
  (data (i32.const 0) "view-i64.bin")
  (func (export "run") (result i32)
    (local $a (ref $a)) (local $dir i32) (local $fd i32) (local $e i32) (local $n i64) (local $off i64)
    (local.set $a (array.new_fixed $a 1 (i64.const 1234605616436508552)))
    ...
    (call $writea (local.get $fd) (local.get $a) (i64.const 0) (i64.const 8)) (local.set $e) (local.set $n)
    (call $seek (local.get $fd) (i64.const 0) (i32.const 0)) (local.set $e) (local.set $off)
    (call $read (local.get $fd) (i32.const 0) (i32.const 128) (i32.const 8)) (local.set $e) (local.set $n)
    (i32.or (local.get $e) (i64.ne (i64.load (i32.const 128)) (i64.const 1234605616436508552))))
)
