...
(module
  ...
  (import "facet" "socket_listen" (func $listen (param i32 i32) (result i32)))
  (import "facet" "socket_accept" (func $accept (param i32 i32) (result i32 i32 i64 i64 i32 i32 i32)))
