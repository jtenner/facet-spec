...
(module
  ...
  (func $probe-errors (result i32)
    ...
    (local.set $e (call $mkdir (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 8) (i32.const 0)))
    (if (i32.ne (local.get $e) (i32.const 4)) (then (return (i32.const 1))))
    (local.set $e (call $remove (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 8) (i32.const 0) (i32.const 0)))
