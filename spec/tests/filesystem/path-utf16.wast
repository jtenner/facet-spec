...
(module
  ...
  (import "wpsi" "path_open_mem32_i16" (func $open (param i32 i32 i32 i32 i32 i32 i64) (result i32 i32)))
  ...
  (func (export "run") (result i32)
    ...
    (call $open (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 8) (i32.const 0) (i32.const 0) (i64.const 17)) (local.set $e) (local.set $fd)
