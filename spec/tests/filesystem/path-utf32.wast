...
(module
  ...
  (func $probe-errors
    (local $e i32)
    (call $require-error (call $mkdir (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 5) (i32.const 0)))
    (call $require-error (call $remove (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 5) (i32.const 0) (i32.const 0)))
