...
(module
  ...
  (import "wpsi" "path_rename_mem32" (func $rename (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  (import "wpsi" "path_remove_mem32" (func $remove (param i32 i32 i32 i32 i32 i32) (result i32)))
  (import "wpsi" "path_stat_mem32" (func $stat (param i32 i32 i32 i32 i32 i32) (result i32 i32 i64 i64 i32 i64 i32 i64 i32 i32)))
  ...
  (func $staterr (param $dir i32) (param $ptr i32) (result i32)
    ...
    (call $stat (local.get $dir) (i32.const 0) (local.get $ptr) (i32.const 7) (i32.const 1) (i32.const 0))
  ...
  (func (export "run") (result i32)
    ...
    (call $open (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 7) (i32.const 1) (i32.const 1) (i64.const 63)) (local.set $e) (local.set $fd)
    (drop (call $close (local.get $fd)))
    (local.set $e (call $rename (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 7) (i32.const 1) (local.get $dir) (i32.const 0) (i32.const 16) (i32.const 7) (i32.const 1) (i32.const 1)))
    ...
    (local.set $e (call $remove (local.get $dir) (i32.const 0) (i32.const 16) (i32.const 7) (i32.const 1) (i32.const 1)))
    (local.get $e))
)
