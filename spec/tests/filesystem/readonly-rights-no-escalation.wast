...
(module
  ...
  (func (export "run") (result i32)
    (local $dir i32) (local $zero i32) (local $name i32) (local $fd i32)
    (local $e i32) (local $zero_e i32) (local $zero_rights i64)

    (call $get (i32.const 0)) (local.set $e) (local.set $dir)
    (call $open (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 7) (i32.const 0) (i32.const 1) (i64.const 3)) (local.set $e) (local.set $fd)

    (call $get (i32.const 1)) (local.set $zero_e) (local.set $zero)
    (call $rights (local.get $zero)) (local.set $zero_e) (local.set $zero_rights)

    (i32.and
      (i32.and (i32.eqz (local.get $fd)) (i32.ne (local.get $e) (i32.const 0)))
      (i32.and (i32.eqz (local.get $zero_e)) (i64.eqz (local.get $zero_rights))))))
