...
(module
  ...
  (func (export "run") (result i32 i32)
    ...
    (call $open (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 13) (i32.const 1) (i32.const 3) (i64.const 63)) (local.set $e) (local.set $fd)
    (drop (call $close (local.get $fd)))
    (call $open (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 13) (i32.const 1) (i32.const 3) (i64.const 63)))
)
