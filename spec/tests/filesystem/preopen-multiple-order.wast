...
;; Purpose: Multiple preopens are returned in manifest order.
...
(module
  ...
  (func $first-byte (param $index i32) (param $at i32) (result i32)
    (local $dir i32) (local $name i32) (local $e i32) (local $n i64)
    (call $get (local.get $index)) (local.set $e) (local.set $name) (local.set $dir)
    (call $read (local.get $name) (i32.const 1) (i32.const 0) (local.get $at) (i32.const 1)) (local.set $e) (local.set $n)
