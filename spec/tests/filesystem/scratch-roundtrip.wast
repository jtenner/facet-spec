;; WPSI conformance test: filesystem/scratch-roundtrip
;; Purpose: Scratch supports create, write, seek, read, and close without a host preopen.
...
(module
  ...
  (import "wpsi" "fd_set_size" (func $set_size (param i32 i64) (result i32)))
  ...
  (memory 1)
  (data (i32.const 0) "roundtrip.txt")
  ...
  (func (export "run") (result i32)
    ...
    (call $open (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 13) (i32.const 1) (i32.const 5) (i64.const 63)) (local.set $e) (local.set $fd)
    (if (local.get $e) (then (return (local.get $e))))
