...
(module
  ...
  (memory $a 1)
  (memory $b 1)
  (data (memory $a) (i32.const 100) "abc")
  (data (memory $b) (i32.const 200) "DEF")
  (data (memory $a) (i32.const 300) "vector.bin")
  ...
  (func (export "run") (result i32)
    ...
    (call $open (local.get $dir) (i32.const 0) (i32.const 300) (i32.const 10) (i32.const 1) (i32.const 5) (i64.const 63)) (local.set $e) (local.set $fd)
    ...
    (call $read (local.get $fd) (i32.const 0) (i32.const 400) (i32.const 6)) (local.set $e) (local.set $n)
    (drop (call $close (local.get $fd))) (drop (call $close (local.get $dir)))
    (i32.or (local.get $e)
      (i32.or (i64.ne (local.get $n) (i64.const 6))
        (i32.or (i32.ne (i32.load (i32.const 400)) (i32.const 1145258561))
                (i32.ne (i32.load16_u (i32.const 404)) (i32.const 17989))))))
)
