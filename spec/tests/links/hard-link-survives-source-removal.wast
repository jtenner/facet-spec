...
(module
  ...
  (import "wpsi" "path_link_mem32" (func $link (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  ...
  (func (export "run") (result i32)
    ...
    (call $open (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 10) (i32.const 1) (i32.const 1) (i64.const 63)) (local.set $e) (local.set $fd)
    (drop (call $close (local.get $fd)))
    (local.set $e (call $link (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 10) (i32.const 1) (local.get $dir) (i32.const 0) (i32.const 32) (i32.const 9) (i32.const 1) (i32.const 0)))
    (local.set $e (call $remove (local.get $dir) (i32.const 0) (i32.const 0) (i32.const 10) (i32.const 1) (i32.const 1)))
    (call $open (local.get $dir) (i32.const 0) (i32.const 32) (i32.const 9) (i32.const 1) (i32.const 0) (i64.const 17)) (local.set $e) (local.set $fd)
